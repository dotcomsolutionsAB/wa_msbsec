...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="../assets/js/pages/custom/tel_input/css/intlTelInput.css">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-aside--minimize kt-page--loading">
		...
		<script src="../assets/js/pages/custom/tel_input/js/intlTelInput-jquery.min.js"></script>
        <script src="../assets/js/pages/custom/tel_input/js/intlTelInput.min.js"></script>
